...
class CZenitsu final : public CPlayer
{
protected:
	explicit CZenitsu(ID3D11Device*& _pDevice, ID3D11DeviceContext*& _pContext);
	explicit CZenitsu(const CZenitsu& _rhs);
...
private:
	// 궁극기 진행시킬 시간
	_double	m_dUltimateAcc = 0.0;

public:
	static CZenitsu* Create(ID3D11Device*& _pDevice, ID3D11DeviceContext*& _pContext);
