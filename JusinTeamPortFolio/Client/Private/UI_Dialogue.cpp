...
CUI_Dialogue::CUI_Dialogue(ID3D11Device*& _pDevice, ID3D11DeviceContext*& _pContext)
...
CUI_Dialogue::CUI_Dialogue(const CUI_Dialogue& _rhs)
    : CUI_Base(_rhs)
{
    XMStoreFloat4x4(&m_ProjMatrix, XMMatrixIdentity());
}
...
HRESULT CUI_Dialogue::NativeConstruct_Prototype()
{
    return S_OK;
}

HRESULT CUI_Dialogue::NativeConstruct_Clone(void* pArg)
{
...
void CUI_Dialogue::Tick(const _double& _dTimeDelta)
{
...
void CUI_Dialogue::Late_Tick(const _double& _dTimeDelta)
{
...
HRESULT CUI_Dialogue::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(COM_TEXTURE, LEVEL_STATIC, TEXT("Prototype_Component_Texture_UI_Dialogue"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CUI_Dialogue::SetUp_ConstantTable()
{
...
CUI_Base* CUI_Dialogue::Clone(void* pArg)
{
