...
CSoundMgr::CSoundMgr(CGameMgr *& pGameMgr) : CManager(pGameMgr), m_pSystem(nullptr)
{
}
...
void CSoundMgr::LoadSoundFile(const char* szPath)
{
	// _finddata_t : <io.h>에서 제공하며 파일 정보를 저장하는 구조체
	_finddata_t fd; 

	// _findfirst : <io.h>에서 제공하며 사용자가 설정한 경로 내에서 가장 첫 번째 파일을 찾는 함수
	long handle = _findfirst(szPath, &fd);
