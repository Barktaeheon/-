...
class CZenitsu_GamePad_Controller final : public CPlayer_GamePad_Controller
{
private:
	explicit CZenitsu_GamePad_Controller(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	virtual ~CZenitsu_GamePad_Controller() = default;
public:
...
public:
	static CZenitsu_GamePad_Controller* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, class CGameObject* _pGameObject);
