...
class CAkaza_GamePad_Controller : public CPlayer_GamePad_Controller
{
protected:
	explicit CAkaza_GamePad_Controller(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	virtual ~CAkaza_GamePad_Controller() = default;
...
public:
	static CAkaza_GamePad_Controller* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, CGameObject* _pGameObject);
