...
class CPlayer_GamePad_Controller : public CGamePad_InputController
{
public:
...
protected:
	explicit CPlayer_GamePad_Controller(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	virtual ~CPlayer_GamePad_Controller() = default;
